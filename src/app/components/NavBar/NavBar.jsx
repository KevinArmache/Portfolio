...
export default function NavBar() {
  ...
  return (
    <div className=" border-b-2 border-black md:flex hidden ">
      <div className=" w-3/4">
          ...
          {activePage === "/home" ? (
            ...
            <li className="nav-bar-item">
              ...
              >
                ...
                <span
                  className={`font-bold mx-2 my-text-shadow text-secondary-color text-xl`}
                >
                  HOME
                </span>
              </Link>
          ...
          {activePage === "/project" ? (
            ...
            <li className="nav-bar-item">
              ...
              >
                ...
                <span
                  className={`my-text-shadow font-bold mx-2 text-secondary-color text-xl`}
                >
                  PROJECT
                </span>
              </Link>
