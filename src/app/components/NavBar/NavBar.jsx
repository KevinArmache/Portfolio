        ...
        <ul className="flex p-4 items-center">
          {activePage === "/" ? (
            <li>
              ...
              >
                ...
                <span
                  className={`${rodin.className} mx-2 text-primary-color text-xl`}
                >
                  HOME
                </span>
              </Link>
            ...
            <li>
              ...
              >
                ...
                <span
                  className={`${rodin.className} mx-2 text-secondary-color text-xl`}
                >
                  HOME
                </span>
              </Link>
          ...
          {/* <li>
            ...
            >
              ...
              <span
                className={`${rodin.className} m-1 text-secondary-color text-xl`}
              >
                CONTACT
              </span>
            </Link>
